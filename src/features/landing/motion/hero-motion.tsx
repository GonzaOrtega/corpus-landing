      ...
      .then(({ gsap }) => {
        ...
        const context = gsap.context(() => {
          ...
          timeline
            ...
            .to(
              split.wordElements,
              { y: '0%', duration: 1, stagger: 0.07, ease: 'power4.out' },
              0.6,
            )
        ...
        teardown = () => {
          ...
          delete document.documentElement.dataset.heroMotionReady;
        };
      })
      .catch(() => {
