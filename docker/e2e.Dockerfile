...
# directory owned by the compose service's uid (see compose.yaml's `user:`)
# is what lets bun write into it as a non-root user.
RUN mkdir -p /work/node_modules && chown 1000:1000 /work/node_modules
